...
router.post('/login', async (req, res) => {
    ...
    res.cookie('username', req.body.username, {domain: ".herokuapp.com"})
    res.cookie('email', user.email, {domain: ".herokuapp.com"})
    res.cookie('auth_token', token, {domain: ".herokuapp.com"})
